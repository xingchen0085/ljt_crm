...
<form id="form" method="post" action="${baseURL}/sys/role/assignPermission" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
