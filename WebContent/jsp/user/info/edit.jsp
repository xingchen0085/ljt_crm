...
<div class="pageContent">
    <form action="${baseURL }/user/info/edit" cssClass="pageForm required-validate"
            ...
            <div>
                <fieldset>
                    ...
                    <dl>
                        <dt>用户编号：</dt>
                        <dd>
                            <input type="text" name="userNo" value="${userInfo.userNo}" readonly="readonly" size="25"
                                   maxlength="50"/>
                        </dd>
                    </dl>
                    <dl>
                        <dt>用户名称：</dt>
                        <dd>
                            <input type="text" name="userName" value="${userInfo.userName}" class="required" size="25"
                                   maxlength="100"/>
                        </dd>
                    </dl>
                    <dl style="width: 400px">
                        ...
                        <dd style="width: 260px">
                            <input type="number" class="required" value="${userInfo.mobile}" style="width: 176px"
                                   name="mobile" size="25" maxlength="11" id="mobile" onchange="checkPhone()"/>
                            <span id="tips"></span>
                        </dd>
                    </dl>
                    <%--<dl>
                        <dt>登录密码：</dt>
                        <dd>
                            <input type="password" value="${userInfo.password}" name="password" class="required"
