package com.douples.pay.common.exception;
...
public class BizException extends RuntimeException {
     ...
     * 渠道网关信息不全时
     */
    public static final BizException DB_GET_GATEWAY_VALUE_ERROR = new BizException(
            10040008, "渠道网关信息不全，确认 domain,domainTest,port,portTest,payVersion,payVersionTest 均已配置");

    /**
     * 缓存更新失败
     */
    public static final BizException REDIS_CACHE_ERROR = new BizException(
            10040009, "redis缓存更新失败,请确认缓存配置正确，或者尝试手动清除缓存.");
